...
#applying the variable question.
Answer = input("What is the capital of France?:")
if Answer =="Paris" : #inserting the answer to the question
    print("the answer is correct") #if the answer is Paris then it will be correct
else:
    print("the answer is wrong.") #If the answer will be wrong it won't be paris 
